...
<head>
    ...
    <title>Wager — Crypto Gaming</title>
    ...
    <div class="container">
        ...
        <div id="wager-tab" class="tab-content active">
            ...
            <div class="selected-game-display" id="selectedGameDisplay">
                ...
                <button class="selected-game-remove" onclick="clearGame()">×</button>
            </div>

            <div class="info-box warning visible" id="verificationNotice">
                ⚠️ <strong>Verification Required:</strong> Winners must submit a screenshot of the match result.  The opponent has 24h to dispute. 
            </div>
            ...
            <div class="fee-notice">3% platform fee on total pot • Funds held in escrow until verified</div>
            ...
            <div id="result">
                ...
                <div class="result-note">Funds held in escrow • Winner must submit proof</div>
            </div>
        </div>
        ...
        <div id="accounts-tab" class="tab-content">
            <div class="info-box info visible">
                🔗 Link your gaming accounts to verify match results.  We use official APIs where available.
            </div>
    ...
    <div class="modal">
        ...
        <div class="modal-body">
            <div class="info-box info visible" style="margin-bottom: 1rem;">
                📸 Upload a screenshot showing the final match result with both players/teams visible. 
            </div>
...
<div class="modal-overlay" id="wagerModal">
    <div class="modal">
        <div class="modal-header">
            ...
            <button class="modal-close" onclick="closeModal('wagerModal')">×</button>
        </div>
    ...
    <div class="modal">
        ...
        <div class="modal-body">
            <div class="info-box warning visible" style="margin-bottom: 1rem;">
                ⚠️ False disputes may result in account penalties.  Only dispute if you have evidence. 
            </div>
            ...
            <div class="form-group">
                ...
                <div class="dispute-reasons" id="disputeReasons">
                    <label class="dispute-reason" onclick="selectDisputeReason(this)">
                        ...
                        <span class="dispute-checkbox">✓</span>
...
<div class="modal-overlay" id="linkModal">
    <div class="modal">
        ...
        <div class="modal-body">
            <div class="info-box info visible" style="margin-bottom: 1rem;">
                🔐 We'll verify your account ownership.  This helps prevent fraud. 
            </div>
        ...
        reader.onload = (e) => {
            area.innerHTML = `
                ...
                <div class="upload-file-info">
                    ...
                    <button class="upload-remove" onclick="event.stopPropagation(); removeUpload('${areaId}')">×</button>
                </div>
            `;
        };
                ...
                <div class="platform-card">
                    <div class="platform-card-left">
                        ...
                        <div>
                            ...
                            ${linked ? `<div style="font-size: 0.75rem; color: #22c55e; margin-top: 0.25rem;">✓ ${linked.username}</div>` : ''}
                        </div>
                    </div>
                    ${linked 
    ...
    function openWagerModal(wager) {
        ...
        body.innerHTML = `
            <div class="verification-status ${statusClass}">
                <div class="verification-header">
                    <span class="verification-icon">${wager.disputed ? '⚠️' : wager.status === 2 ? '⏳' : wager.status === 4 ? '✅' : '📋'}</span>
            ...
            <div class="timeline" style="margin-top: 1.5rem;">
                ...
                ${wager.status >= 2 ? `
                    <div class="timeline-item">
                        <div class="timeline-dot proof">📷</div>
                        <div class="timeline-content">
                ...
                ${wager.disputed ? `
                    <div class="timeline-item">
                        <div class="timeline-dot disputed">⚠️</div>
                        <div class="timeline-content">
